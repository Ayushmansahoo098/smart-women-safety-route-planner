    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1, color: "#475569", fontSize: "0.75rem" }}>
          © 2024 SafeRoute Pro. Protected by industry-grade encryption.
        </div>
      </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
              ...
              <div>
                ...
                <div style={{ ...inputWrapStyle, borderColor: showConfirmError ? "#f43f5e" : "#1e293b" }}>
                  <span style={iconStyle}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" /><path d="M12 8v4l3 3" /></svg>
                  </span>
                  <input
                    id="reg-confirm"
                    type="password"
